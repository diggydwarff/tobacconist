...
The rack commands resolve the single wooden Drying Rack directly, resolve the shared curing batch from either half of an Industrial Drying Rack, and recognize a Hanging Tobacco Bunch from either half:
