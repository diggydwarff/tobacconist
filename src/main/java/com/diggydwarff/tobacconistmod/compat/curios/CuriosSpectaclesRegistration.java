...
public final class CuriosSpectaclesRegistration {
    ...
    private static void commonSetup(FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            // The #curios:head tag assigns the slot. Registering an explicit Curio capability
            // matches Curios' supported extension path and avoids relying on implicit attachment.
