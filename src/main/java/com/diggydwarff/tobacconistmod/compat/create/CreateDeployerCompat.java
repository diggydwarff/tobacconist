...
public final class CreateDeployerCompat {
    ...
    public static void register() {
        MinecraftForge.EVENT_BUS.addListener(CreateDeployerCompat::onDeployerRecipeSearch);
    ...
    private static boolean tryBrassBoxLabel(DeployerRecipeSearchEvent event, ItemStack input, ItemStack heldItem) {
        ...
        DeployerApplicationRecipe recipe = new ProcessingRecipeBuilder<>(
        ...
        event.addRecipe(() -> Optional.of(recipe), BRASS_LABEL_PRIORITY);
        return true;
    }
    ...
    private static boolean tryBoxPacking(DeployerRecipeSearchEvent event, ItemStack input, ItemStack heldItem) {
        ...
        event.addRecipe(() -> Optional.of(recipe), BOX_PACKING_PRIORITY);
        return true;
    }
    ...
    private static boolean tryProductAssembly(DeployerRecipeSearchEvent event, ItemStack input, ItemStack heldItem) {
        ...
        ResourceLocation recipeId = new ResourceLocation(TobacconistMod.MODID, recipePath);
        DeployerApplicationRecipe recipe = new ProcessingRecipeBuilder<>(
                DeployerApplicationRecipe::new,
                recipeId
        )
        ...
        event.addRecipe(() -> Optional.of(recipe), PRODUCT_ASSEMBLY_PRIORITY);
        return true;
    }
    ...
    private static boolean tryChavetaCutting(DeployerRecipeSearchEvent event, ItemStack input, ItemStack heldItem) {
        ...
        event.addRecipe(() -> Optional.of(recipe), CHAVETA_RECIPE_PRIORITY);
        return true;
    }
}
