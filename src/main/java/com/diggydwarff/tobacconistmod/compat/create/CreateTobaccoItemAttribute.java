...
public final class CreateTobaccoItemAttribute implements ItemAttribute {
    private String category;
    private String value;

    public CreateTobaccoItemAttribute(String category, String value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CreateTobaccoItemAttribute other)) return false;
