...
public class CigarRecipeCategory implements IRecipeCategory<CigarJeiRecipe> {
    ...
    public static final RecipeType<CigarJeiRecipe> TYPE =
            new RecipeType<>(ResourceLocation.fromNamespaceAndPath(TobacconistMod.MODID, "cigar_rolling"), CigarJeiRecipe.class);
    ...
    public Component getTitle() {
        return Component.translatable("tobacconistmod.jei.cigar_rolling");
    }
    ...
    public void draw(CigarJeiRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics,
        ...
        guiGraphics.drawString(mc.font,
                Component.translatable("tobacconistmod.jei.loose_tobacco_plus_leaf"),
                4, 4, 0x404040, false);
    }
}