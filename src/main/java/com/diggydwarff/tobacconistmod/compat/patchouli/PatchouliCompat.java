...
/** Loaded only after the caller confirms Patchouli is installed. */
public final class PatchouliCompat {
    private static final ResourceLocation MANUAL_ID = new ResourceLocation(TobacconistMod.MODID, "tobacco_manual");
