...
public class OrientalCropBlock extends AbstractTallTobaccoCropBlock {
    ...
    protected TobaccoGrowthHelper.Variety getVariety() {
        return TobaccoGrowthHelper.Variety.ORIENTAL;
    }

    @Override
    protected Item getLeafItem() {
        return ModItems.ORIENTAL_TOBACCO_LEAF.get();
    }
