 ...
 * extraction. The industrial rack follows the same top-or-side input rule. Finished batches may be extracted
...
final class DryingRackItemHandler implements IItemHandler {
    ...
    private boolean canInsertFromSide() {
        ...
        // Both wooden and industrial racks use top/sides for input; bottom is output-only.
